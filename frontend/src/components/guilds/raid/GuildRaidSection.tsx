...
export default function GuildRaidSection({ raid }: Props) {
    ...
    return (
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl border border-teal-500/30 p-6 relative overflow-hidden mb-8 group">
            {/* Background Effects */}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="relative flex-shrink-0">
                    <div className={`w-32 h-32 rounded-full bg-black/50 border-4 border-teal-500/50 flex items-center justify-center relative overflow-hidden ${isCleared ? 'grayscale opacity-50' : 'animate-pulse-slow'}`}>
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-teal-900/80 text-teal-200 text-[10px] font-bold px-2 py-0.5 rounded-full border border-teal-500/50 whitespace-nowrap">
                        RAID BOSS
                    </div>
                </div>
                ...
                <div className="flex-1 w-full text-center md:text-left">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-2">
                        ...
                        <div className="text-right hidden md:block">
                            <div className="text-xs text-teal-400 font-mono">PROJECT PROGRESS</div>
