...
namespace FocusArena.Infrastructure.Migrations
{
    ...
    [Migration("20260214175437_AddGuildRaids")]
    partial class AddGuildRaids
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FocusArena.Domain.Entities.AppTask", b =>
                {
                    ...
                    b.Property<int?>("GuildRaidId")
                        .HasColumnType("int");

                    b.Property<bool>("IsGuildTask")
            ...
            modelBuilder.Entity("FocusArena.Domain.Entities.Friendship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FocusArena.Domain.Entities.GuildRaid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FocusArena.Domain.Entities.PrivateMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FocusArena.Domain.Entities.AppTask", b =>
                {
                    ...
                    b.HasOne("FocusArena.Domain.Entities.GuildRaid", "GuildRaid")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("FocusArena.Domain.Entities.Friendship", b =>
                {
                    b.HasOne("FocusArena.Domain.Entities.User", "Addressee")
                        .WithMany()
                        .HasForeignKey("AddresseeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FocusArena.Domain.Entities.User", "Requester")
                        .WithMany()
            ...
            modelBuilder.Entity("FocusArena.Domain.Entities.Guild", b =>
                {
                    b.HasOne("FocusArena.Domain.Entities.User", "Leader")
                        .WithOne("Guild")
                        .HasForeignKey("FocusArena.Domain.Entities.Guild", "LeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FocusArena.Domain.Entities.PrivateMessage", b =>
                {
                    b.HasOne("FocusArena.Domain.Entities.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FocusArena.Domain.Entities.User", "Sender")
                        .WithMany()
